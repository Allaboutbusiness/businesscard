...
# ── 단일 소스: 구성원 데이터 ──
MEMBERS = {
    "조기열": dict(eng="jokiyeol", role="경영지도사", photo="/hero-jokiyeol.png?v830", src="card-jokiyeol.jpg", vd=True,
    ...
    "유우선": dict(eng="yuwooseon", role="수석 경영컨설턴트", photo="/hero-yuwooseon.png?v830", src="card-yuwooseon.jpg", vd=True,
    ...
    "류예주": dict(eng="ryuyeju", role="AC 대표", photo="/hero-ryuyeju.png?v830", src="card-ryuyeju.jpg", vd=True,
    ...
    "이승원": dict(eng="leeseungwon", role="행정사", photo="/hero-leeseungwon.png?v830", src="card-leeseungwon.jpg", vd=True,
    ...
    "안지수": dict(eng="anjisu", role="변리사", photo="/hero-anjisu.png?v830", src="card-anjisu.jpg", vd=True,
        ...
        tags=["특허", "상표", "지식재산", "IP"]),
    "채용현": dict(eng="chaeyonghyun", role="변호사 · 세무사 · 변리사", photo="/hero-chaeyonghyun.png?v830", src="card-chaeyonghyun.jpg", vd=True,
        ...
        tags=["법률", "세무", "상속", "분쟁"]),
    "송기훈": dict(eng="songgihoon", role="회계사", photo="/hero-songgihoon.png?v830", src="card-songgihoon.jpg", vd=True,
    ...
    "우희연": dict(eng="wooheeyeon", role="수석 경영컨설턴트", photo="/hero-wooheeyeon.png?v830", src="card-wooheeyeon.jpg", vd=True,
        tagline="공공조달부터 프랜차이즈·수출까지,<br>기업의 판로와 성장을 설계합니다",
        ogdesc="공공입찰·프랜차이즈·국내외 판로개척 — 수석 경영컨설턴트 우희연. 오너스경영연구소 전문 컨설팅 그룹. 3회 무료 상담.",
        career=["수석 경영컨설턴트", "공공입찰·프랜차이즈 전략", "국내외 판로개척"],
        tags=["공공조달", "프랜차이즈", "수출", "판로개척"]),
}
